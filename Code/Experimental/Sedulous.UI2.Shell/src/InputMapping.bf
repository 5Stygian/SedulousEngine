...
static class InputMapping
{
	...
	public static Sedulous.UI2.KeyModifiers MapModifiers(Sedulous.Shell.Input.KeyModifiers shellMods)
	{
		Sedulous.UI2.KeyModifiers result = .None;
	...
	public static Sedulous.UI2.MouseButton MapMouseButton(Sedulous.Shell.Input.MouseButton shellButton)
	{
		return (.)shellButton;
	}

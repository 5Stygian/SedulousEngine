...
public class Dialog : ViewGroup
{
	...
	public this(StringView title)
	{
		...
		mLayout.AddView(mTitleLabel, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 24 });

		// Button row (right-aligned).
		mButtonRow = new LinearLayout();
		mButtonRow.Orientation = .Horizontal;
		mButtonRow.Spacing = 8;
		mLayout.AddView(mButtonRow, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 36 });
	}
	...
	public void SetContent(View content)
	{
		...
		mLayout.AddView(content, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 0, Weight = 1 });
		mLayout.AddView(mButtonRow, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 36 });
	}
	...
	public Button AddButton(StringView text, DialogResult result)
	{
		...
		mButtonRow.AddView(btn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		return btn;
	}

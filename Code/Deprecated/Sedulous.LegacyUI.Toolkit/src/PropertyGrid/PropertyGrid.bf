...
public class PropertyGrid : ViewGroup
{
	...
	public this()
	{
		...
		mContent.Spacing = 1;
		mScrollView.AddView(mContent, new LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent });
	}
	...
	private void RebuildLayout()
	{
		...
		for (let catName in categoryOrder)
		{
			...
			expander.SetContent(catContent, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent });
			mContent.AddView(expander, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent });
		}
	...
	private void AddEditorRowTo(LinearLayout container, PropertyEditor editor, bool alt)
	{
		...
		container.AddView(row, new LinearLayout.LayoutParams() {
			Width = Sedulous.LegacyUI.LayoutParams.MatchParent,
			Height = Sedulous.LegacyUI.LayoutParams.WrapContent
		});
	}
}

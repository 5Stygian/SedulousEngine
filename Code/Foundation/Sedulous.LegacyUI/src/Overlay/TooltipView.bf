...
public class TooltipView : ViewGroup
{
	...
	public void SetText(StringView text)
	{
		...
		else
		{
			...
			label.FontSize = 13;
			mContent = label;
			AddView(label, new LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		}
	}
	...
	public void SetContent(View content)
	{
		...
		mContent = content;
		if (content != null)
			AddView(content, new LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
	}

namespace Sedulous.LegacyUI.Shell;
...
static class InputMapping
{
	...
	public static Sedulous.LegacyUI.KeyCode MapKey(Sedulous.Shell.Input.KeyCode shellKey)
	{
		// Values match by design - trivial cast works for all common keys.
		return (Sedulous.LegacyUI.KeyCode)(int)shellKey;
	}

	/// Maps Shell.Input.KeyModifiers to UI.KeyModifiers.
	public static Sedulous.LegacyUI.KeyModifiers MapModifiers(Sedulous.Shell.Input.KeyModifiers shellMods)
	{
		Sedulous.LegacyUI.KeyModifiers result = .None;
	...
	public static Sedulous.LegacyUI.MouseButton MapMouseButton(Sedulous.Shell.Input.MouseButton shellButton)
	{
		return (.)shellButton;
	}

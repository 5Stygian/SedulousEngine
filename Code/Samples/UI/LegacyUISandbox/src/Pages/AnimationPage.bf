...
class AnimationPage : DemoPage
{
	public this(DemoContext demo) : base(demo)
	{
		...
		mLayout.AddView(animTarget, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 30 });

		let animRow = new LinearLayout();
		animRow.Orientation = .Horizontal;
		animRow.Spacing = 6;
		mLayout.AddView(animRow, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 28 });
		...
		animRow.AddView(fadeOutBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		animRow.AddView(fadeInBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		animRow.AddView(bounceBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		animRow.AddView(slideBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		mLayout.AddView(transformRow, new LinearLayout.LayoutParams() { Width = Sedulous.LegacyUI.LayoutParams.MatchParent, Height = 40 });
		...
		transformRow.AddView(rotBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		transformRow.AddView(scaleBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
		...
		transformRow.AddView(skewBtn, new LinearLayout.LayoutParams() { Height = Sedulous.LegacyUI.LayoutParams.MatchParent });
	}
}
